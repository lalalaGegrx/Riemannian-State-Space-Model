...
from Model.utils import BaseDataset_RSSM_static, calculate_metrics
...
if __name__ == "__main__":
    ...
    for sub in range(1, args.subjects + 1):
        ...
        # Dataset
        dataset = BaseDataset_RSSM_static(X1, Y1, samples_cumsum, args)
    ...
    sio.savemat('/data/lalalagegrx/RiemannianRNN/EcoGLibrary/SEED/Results/SPDNet/SPDNet_RSSM_10fold_shuffle_results.mat', {'acc':acc_l, 'mf1': mf1_l})
