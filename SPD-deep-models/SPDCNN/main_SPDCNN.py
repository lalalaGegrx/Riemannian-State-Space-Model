...
from Model.SPDCNN import SPDCNN
from SPDCNN.train_SPDCNN import train_op, test_op
...
if __name__ == "__main__":
    ...
    for sub in range(1, args.subjects + 1):
        ...
        for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
            ...
            if args.model == "SPDCNN":
                model = SPDCNN(args.latents, args.T, args.classes).to(device)
    ...
    sio.savemat('/data/lalalagegrx/RiemannianRNN/EcoGLibrary/SEED/Results/SPDCNN/SPDCNN_results.mat', {'acc':acc_l, 'mf1': mf1_l})
