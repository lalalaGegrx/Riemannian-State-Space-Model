...
from Model.ManifoldDCNN import manifoldDCNN
from MDCNN.train_MDCNN import train_op, test_op
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', default='MDCNN')
    ...
    for sub in range(1, args.subjects + 1):
        ...
        for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
            ...
            if args.model == "MDCNN":
                model = manifoldDCNN(args.classes, args.latents, device=device).to(device)
    ...
    sio.savemat('/data/lalalagegrx/RiemannianRNN/EcoGLibrary/SEED/Results/MDCNN/MDCNN_RSSM_10fold_shuffle_results.mat', {'acc':acc_l, 'mf1': mf1_l})
