...
from Model.MAtt import mAtt_bci
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', default='MAtt')
    ...
    for sub in range(1, args.subjects + 1):
        ...
        for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
            ...
            if args.model == "MAtt":
                model = mAtt_bci(args.latents, args.units, args.T, args.classes).to(device)
    ...
    sio.savemat('/data/lalalagegrx/RiemannianRNN/EcoGLibrary/SEED/Results/MAtt/MAtt_RSSM_10fold_shuffle_results.mat', {'acc':acc_l, 'mf1': mf1_l})
